...
<p align="center"><b>Claude Code 技能体检医生 —— 安装前先查一查，避免踩坑</b></p>
...
Claude Code 技能市场越来越热闹，但不是每个技能都名副其实：
...
# 2. 解压到 ~/.claude/skills/skill-evaluator/
```

装完后，在 Claude Code 里直接输入：

> **"帮我看看这个技能值不值得装"**
> **"评估一下 ship 技能"**
> **"我装的技能里哪个最好？"**

skill-evaluator 会自动运行安全门禁 + 五维评分 + 输出报告。

> **💡 确保你装了 Claude Code 的最新版本。** 技能存放在 `~/.claude/skills/` 目录，Claude Code 启动时自动识别。
...
> **"评估一下 ~/.claude/skills/ 下所有的技能"**
> **"ship 这个技能值不值得装"**
> **"帮我看看 playground 新下的那个技能"**
